...
export const useMedicalExaminationsByEmployee = (employeeId: number) => {
  ...
  >({
    queryKey: medicalExaminationsKeys.byEmployee(employeeId),
    queryFn: () => MedicalExaminationsApi.getByEmployee(employeeId),
    enabled: !!employeeId,

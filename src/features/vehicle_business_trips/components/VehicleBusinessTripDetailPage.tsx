            ...
            <Stack direction="row" spacing={3} alignItems="center">
                 <Box display="flex" alignItems="center">
                       <Box
                         ...
                         sx={{ width: 40, height: 40,  bgcolor: alpha(theme.palette.primary.main, 0.1), mr: 2, color: "primary.main" }}
                       >
                            <LocalShippingIcon />
                       </Box>
                       <Box>
                ...
                <Box display="flex" alignItems="center">
                       <Box
                         ...
                         alignItems="center"
                         justifyContent="center"
                         sx={{ width: 40, height: 40,  bgcolor: alpha(theme.palette.info.main, 0.1), mr: 2, color: "info.main" }}
                       >
                            <PersonIcon />
                       </Box>
                       <Box>
      ...
      <Stack direction={{ xs: "column", md: "row" }} spacing={3} alignItems="stretch">
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
             <Paper elevation={0} sx={{ p: 3, border: `1px solid ${theme.palette.divider}`,  height: "100%" }}>
                 ...
                 <Box sx={{ position: "relative", pl: 2, borderLeft: `2px dashed ${theme.palette.divider}`, ml: 1 }}>
                    ...
                    <Stack spacing={2}>
                        <Stack direction="row" spacing={2}>
                            <Box flex={1}>
                                <Stack spacing={0.5}>
                                    <Stack direction="row" alignItems="center" spacing={0.5} color="text.secondary">
                                        ...
                                        <Typography variant="caption">{t("vehicleBusinessTrips.form.field.startKilometers")}</Typography>
                                    </Stack>
                            ...
                            <Box flex={1}>
                                <Stack spacing={0.5}>
                                    <Stack direction="row" alignItems="center" spacing={0.5} color="text.secondary">
                                        <SpeedIcon fontSize="small" />
                                        <Typography variant="caption">{t("vehicleBusinessTrips.form.field.endKilometers")}</Typography>
                                    </Stack>
                                    <Typography variant="h6">
                                        {trip.endKilometers ?? "—"}
                                    </Typography>
                            ...
                            <Box flex={1}>
                                <Stack spacing={0.5}>
                                    <Stack direction="row" alignItems="center" spacing={0.5} color="text.secondary">
                                        ...
                                        <Typography variant="caption">{t("vehicleBusinessTrips.form.field.refueled")}</Typography>
                                    </Stack>
                                    <Chip
                        ...
                        {trip.refueled && (
                           <>
                             <Stack direction="row" spacing={2}>
                                <Box flex={1}>
                                    <Stack spacing={0.5}>
                                        <Stack direction="row" alignItems="center" spacing={0.5} color="text.secondary">
                                            <LocalGasStationIcon fontSize="small" />
                                            <Typography variant="caption">{t("vehicleBusinessTrips.form.field.fuelLiters")}</Typography>
                                        </Stack>
                            ...
                            <Paper variant="outlined" sx={{ p: 1.5, bgcolor: alpha(theme.palette.warning.main, 0.05), borderColor: alpha(theme.palette.warning.main, 0.2), mt: "auto" }}>
